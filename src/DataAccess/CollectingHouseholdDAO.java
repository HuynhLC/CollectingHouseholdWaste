...
public class CollectingHouseholdDAO {

    private static CollectingHouseholdDAO instance = null;
    Library l;

    public CollectingHouseholdDAO() {
        l = new Library();
    }

    public static CollectingHouseholdDAO Instance() {
        if (instance == null) {
            synchronized (CollectingHouseholdDAO.class) {
                if (instance == null) {
                    instance = new CollectingHouseholdDAO();
                }
            }
        }
        return instance;
